...
### Azure Synapse Analytics , Rest API , Triggers, Logic Apps, SCD , GIT, DEVOPS (CI/CD)

### Databricks , Apache Spark, Pyspark and big data technologies , Azure Data Lake, Azure Devops
